...
Бэкенд для виджета последних банковских операций клиента. Проект содержит функции
для маскировки номеров карт и счетов, форматирования виджета операций, фильтрации
и сортировки списка операций, а также генераторы для обработки больших объёмов
данных транзакций.
